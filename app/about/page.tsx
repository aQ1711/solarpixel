...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Solar Pixel is a Lahore-based solar installer built on radical transparency and open engineering — real brand pricing, an itemized quotation for every system, and no hidden fees.",
  ...
  return (
    <LegalPageShell title="About Solar Pixel">
      ...
      <p>
        ...
        not the pre-survey guess. We tell you upfront when a site visit is required and what it costs; see our{" "}
        <a href="/terms">Terms of Service</a> for the current site survey fee.
      </p>
