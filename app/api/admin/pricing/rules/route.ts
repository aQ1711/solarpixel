...
const updateRulesSchema = z.object({
  ...
  washingRateTier1PerPanel: z.number().positive().max(50_000).optional(),
  washingRateTier2PerPanel: z.number().positive().max(50_000).optional(),
  washingRateTier3PerPanel: z.number().positive().max(50_000).optional(),
  washingRateTier4PerPanel: z.number().positive().max(50_000).optional(),
  washingMinimumVisitFeePKR: z.number().positive().max(200_000).optional(),
